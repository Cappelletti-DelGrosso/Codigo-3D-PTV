function [ A3, R3, T3, k, R4, T4, F ] = zhan7( H, Vi)%, camara)
Sxy = [20E-3,17E-3; 20E-3,17E-3];
...
clear k x0
ki = [0,0];
[ ~, k0 ] = distorsionar3( H, Vi, ki, A2, R2, T2);%, Sxy(:, camara) );
...
[x,~] = lsqnonlin(@(x) myfun43(x, H, Vi),x0,lb,ub,options);
clear k
